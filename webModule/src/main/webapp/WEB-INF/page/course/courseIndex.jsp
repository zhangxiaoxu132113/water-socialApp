...
<head>
    ...
    <meta name="Keywords" content="<c:forEach items="${requestScope.courseSubjects}" var="item">${item.name}教程,</c:forEach>等"/>
    <meta name="description" content="<c:forEach items="${requestScope.courseSubjects}" var="item">${item.name}教程,</c:forEach>等"/>
